...
HEADER = f"""/*
 * PyAwaitable - Autogenerated distribution copy of version {__version__}
 *
...
def mangle_internal(changed_names: dict[str, str], lines: list[str], index: int) -> None:
    try:
...
def process_files(fp: TextIO) -> None:
    ...
    with logging_context():
        for include in includes:
            assert not include.startswith("pyawaitable/"), "found pyawaitable headers somehow"
